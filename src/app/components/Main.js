 ...
 const handleImageChange = (e) => {
  ...
  return (
    <div className="container auto flex flex-col justify-center items-center p-15">
      <h1 className="text-3xl md:text-xl lg:text-2xl font-bold">
        Employee's Form
      </h1>

      <form
        className="flex flex-wrap justify-center flex-col items-center mt-9 w-[95%] sm:w-[80%] sm:px-5"
      ...
      >
        <div className="w-[100%]">
          ...
          {/* <input
            ...
            name="Address"
            ref={InputAddress}
            className="rounded-3xl text-sm md:text-base Input duration-200 bg-primarylight py-4 mt-2 mb-2 px-5 w-[100%]"
          />
        ...
        <div className="flex w-[100%]  flex-col justify-between gap-4  md:flex-row mt-2 mb-2">
          <div className="w-[100%]">
            <input
              ...
              ref={InputCity}
              placeholder="City"
              className="rounded-3xl text-sm md:text-base Input duration-200 bg-primarylight py-4 px-5 w-[100%] "
            />
          ...
          <div className="w-[100%]">
            <input
              ...
              ref={InputCNIC}
              placeholder="CNIC"
              className="rounded-3xl text-sm md:text-base duration-200 Input bg-primarylight px-5 w-[100%] py-4"
            />
        ...
        <div className="flex w-[100%] justify-between gap-2 md:gap-9 mt-2 mb-2">
          ...
          <div className="w-[100%]">
            <input
              ...
              className="rounded-3xl duration-200 text-sm md:text-base Input bg-primarylight px-5 py-4 w-[100%]"
            />
